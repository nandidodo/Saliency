#a  much MUCH better DCGAN implementatino. Could use for some simple things perhaps
# who even knwos really??? but it's much better documented and cleaner and more useful, from a more skilled coder than the previous one, and that's what matters!
